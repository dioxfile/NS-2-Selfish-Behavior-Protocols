...
3 - No terminal Compile/execute o arquivo Selfish_GENERATOR.cc: 
	* `$ sudo g++  Selfish_GENERATOR.cc -o Selfish_GENERATOR`
	* Agora é só executar o mesmo: `$ ./Selfish_GENERATOR 5 50`. Em que 5 é a quantidade de nós egoístas e 50 é a 			quantidade total de nós na simulação (previamente configurados em 802_11b.tcl).
	* Após a execução de Selfish_GENERATOR, se tudo ocorreu bem, foi criado um rquivo Selfish.tcl com um conteúdo 			semelhante a isso: 
